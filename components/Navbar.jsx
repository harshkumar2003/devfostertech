...
const Navbar = () => {
  ...
  return (
    ...
    <nav className={`w-full px-7 pt-4 pb-1 md:px-5  flex justify-between items-center fixed z-50 ${isScroll ? "bg-black    shadow-sm " : ""}`}>
        ...
        <div className='flex items-center md:pl-1 space-x-3'>
          <Link href="/#contact" className='text-white sm:hidden px-5 py-5 md:px-3 md:py-3 h-[50px]  rounded-full font-medium bg-black border-2 border-[#6CDDC2] items-center justify-items-center flex'>Contact Us</Link>
          <Link href="/blog" className='text-white sm:hidden px-5 py-5 md:px-3 md:py-3 h-[50px]  rounded-full font-medium bg-black border-2 border-[#6CDDC2] items-center justify-items-center flex'>Blog</Link>
        ...
        <ul ref={sideMenuRef} className='md:hidden lg:hidden xl:hidden 2xl:hidden flex flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-[#6CDDC2] transition duration-500'>
          ...
          <li><Link onClick={closeMenu} href="/#work">Our Work</Link></li>
          <li><Link onClick={closeMenu} href="/#about">About</Link></li>
          <li><Link onClick={closeMenu} href="/#why">Why Us</Link></li>
          <div className='grid items-center text-center justify-center' >
            <Link onClick={closeMenu} href="/#contact" className='text-white md:hidden lg:hidden xl:hidden 2xl:hidden px-5 py-5  h-[50px]  rounded-full font-medium bg-black border-2 border-[#6CDDC2] items-center justify-items-center flex text-center'>Contact Us</Link>
            <Link onClick={closeMenu} href="/blog" className='text-white md:hidden lg:hidden xl:hidden 2xl:hidden px-5 py-5  h-[50px]  rounded-full font-medium bg-black border-2 border-[#6CDDC2] items-center justify-items-center flex text-center'>Blog</Link>
          </div>
        </ul>
